    ...
    <>
      ...
      >
        ...
        >
          ...
          {loadingAvatars ? (
            <div className="w-full max-h-[257px] h-full flex items-center justify-center">
          ...
          <button
            ...
            className={cn(
              "btn mt-5 bg-pink-600 hover:bg-pink-700 py-3 px-6 text-slate-50 rounded-lg w-full transition",
              loadingAvatars && "cursor-not-allowed bg-pink-600/80 hover:bg-pink-600/80"
            )}
          >
            Confirmar
          </button>
