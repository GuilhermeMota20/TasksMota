...
export default function ModalWarning({ text, title, children }: ModalWarningProps) {
  return (
    <div className="xl:text-base sm:text-sm text-xs fixed bg-slate-600/[.2] top-0 left-0 w-full h-full z-40 grid place-items-center px-2 text-slate-600 dark:text-slate-200">
